		...
		<div class="content-wrapper">
			...
			<section class="section-hero">
				<div class="hero-content courses-list">
					<div class="container">
						<h1 class="heading">Courses 3 columns</h1>
					</div>
				</div>
			</section>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-course grid-course">
										...
										<div class="course-details">
											<h3 class="title">
												<a href="course.html">Best Measurement course in the world</a>
											</h3>

											<ul class="course-meta">
												<li><span>Instructor:</span> John Isner</li>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-course grid-course">
										<div class="course-thumbnail">
											...
											<img src="img/grid-course-2.jpg" alt="course thumbnail" />
										</div>

										<div class="course-details">
											<h3 class="title">
												<a href="course.html">Culinary courses</a>
											</h3>

											<ul class="course-meta">
												<li><span>Instructor:</span> Zack Thoumb</li>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-course grid-course">
										<div class="course-thumbnail">
											...
											<img src="img/grid-course-3.jpg" alt="course thumbnail" />
										</div>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-course grid-course">
										<div class="course-thumbnail">
											...
											<img src="img/grid-course-4.jpg" alt="course thumbnail" />
										</div>

										<div class="course-details">
											<h3 class="title">
												<a href="course.html">physical exercises for your body</a>
											</h3>

											<ul class="course-meta">
												<li><span>Instructor:</span> Barry Allen</li>
												<li><span>Type:</span> Offline</li>
												<li><span>Category:</span> Sports</li>
											</ul>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-course grid-course">
										<div class="course-thumbnail">
											...
											<img src="img/grid-course-6.jpg" alt="course thumbnail" />
										</div>
										...
										<div class="course-details">
											...
											<ul class="course-meta">
												<li><span>Instructor:</span> John Isner</li>
												<li><span>Type:</span> Online</li>
												<li><span>Category:</span> Education</li>
											</ul>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-course grid-course">
										<div class="course-thumbnail">
											...
											<img src="img/grid-course-5.jpg" alt="course thumbnail" />
										</div>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-course grid-course">
										<div class="course-thumbnail">
											...
											<img src="img/grid-course-7.jpg" alt="course thumbnail" />
										</div>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-course grid-course">
										<div class="course-thumbnail">
											...
											<img src="img/grid-course-8.jpg" alt="course thumbnail" />
										</div>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-course grid-course">
										<div class="course-thumbnail">
											...
											<img src="img/grid-course-9.jpg" alt="course thumbnail" />
										</div>
										...
										<div class="course-details">
											...
											<ul class="course-meta">
												<li><span>Instructor:</span> John Isner</li>
												<li><span>Type:</span> Online</li>
												<li><span>Category:</span> Science</li>
											</ul>
