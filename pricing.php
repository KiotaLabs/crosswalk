...
<!-- 						<div class="col-md-3 col-sm-6">
							<div class="pricing-box simple">
								<div class="pricing-box-header">
									<div class="box-type">Advanced</div>
									<div class="box-value">
										<h2><span>$</span>99</h2>
										<p>Monthly</p>
									</div>
 ...
 -->					</div>
					...
					<!-- Pricing Boxes - V2 -->
<!-- 					<div class="row">
						<div class="col-md-6 pricing-box-wrapper">
							<div class="pricing-box v2 simple">
						...
						<div class="col-md-6 pricing-box-wrapper">
							<div class="pricing-box v2 featured">
								<div class="row row-fit">
									<div class="col-sm-5">
										<div class="pricing-box-header">
											<div class="box-type">premium</div>
