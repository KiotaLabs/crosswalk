...
<!-- 									</a> -->
			...
			<!-- Testimonials Section hiding it for now 
						...
						<div class="container">
							<div class="testimonial">
								<div class="testimonial-wrapper">
									<p class="message">"Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedid quo minus id quos maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus."</p>
									<p class="author">Scott Eastwood, <span class="title">Student</span></p>
								</div>
							</div>
						</div>
					</li>
		...
		-->
			...
			<!-- Courses Section -->
			<!-- commenting out popular courses section
			<section class="section-courses no-padding">
				<div class="container">
					<div class="section-header">
